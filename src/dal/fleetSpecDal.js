const engine = require('../app/models/specification/engine.model');
const FleetSpec = require('../app/models/specification/index');
const weight = require('../app/models/specification/weight.model');
const wheel = require('../app/models/specification/wheel.model');
const transmission = require('../app/models/specification/trasmission.model');
const fuel = require('../app/models/specification/fuel.model');
const performance = require('../app/models/specification/performance.model');
const dimension = require('../app/models/specification/dimension.model');
